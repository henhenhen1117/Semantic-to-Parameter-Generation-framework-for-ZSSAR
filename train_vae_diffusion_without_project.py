...
class Processor:
    ...
    def load_data(self, train_list, train_label, test_list, test_label, batch_size, language_path):
        ...
        # self.train_set = DataSet("/media/zzf/ljn/wsx/PGFA/PGFA-main/output/weight/enhanced_learnable_checkpoints", dim_per_token=768,
        #                          )
    ...
    def load_model(self, in_channels, hidden_channels, hidden_dim,
        ...
        # self.load_transfer_weight(self.mapper,"/media/zzf/ljn/wsx/PGFA/PGFA-main/output/mapper/mapper_best.pt")
        self.load_ske_weights(self.ske_adapter,weight_path)
        # self.load_vae_weights(self.vae,"./output/learnabe_vae/best_vae_0.3637792766094208.pt")
        # self.load_vae_weights(self.vae,"/media/zzf/ljn/wsx/PGFA/PGFA-main/output/learnabe_vae/best_vae_0.09846755117177963.pt")
    ...
    def optimize(self, epoch_num, DA):  # print -> log.info
        ...
        for epoch in range(epoch_num):
            ...
            # self.log.info("epoch [{}] get loss: {}".format(epoch, self.dim_loss))
            # self.log.info("epoch [{}] best loss: {}".format(self.best_epoch, self.best_loss))
    ...
    def train_diff(self, epoch):
        ...
        if self.dim_loss>self.best_loss:
            ...
            self.save_diffusion_model('./output/learnable_vae/diffusion/best_diffusion_{}.pt'.format(self.test_acc))
    ...
    #         with open("./train_VAE_learnable_new_loss.txt", 'a') as train_los:
    #             train_los.write(str(self.dim_loss) + '\n')
    #         if self.dim_loss < self.best_loss:
    #             self.log.info("")
    #             self.best_epoch = epoch
    #             self.best_loss = self.dim_loss
    #             self.save_vae_model('./output/learnabe_vae/best_vae_{}.pt'.format(self.best_loss))
    #             this_steps = 0
    #             train_loss = 0
    #         # if batch_idx >= 500:
    #         #     break
    ...
    def test_epoch_prediction(self,prediction, unseen_label, epoch, DA, support_factor):
        ...
        feat_list = []
        old_pred_list = []
        self.load_text_weights(self.text_adapter,"/media/zzf/ljn/wsx/PGFA/PGFA-main/output/save_param/generated_model.pth")
