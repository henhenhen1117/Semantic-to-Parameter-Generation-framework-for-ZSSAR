...
class Processor:
    ...
    def load_data(self, train_list, train_label, test_list, test_label, batch_size, language_path):
        ...
        self.train_set = DataSet("/media/zzf/ljn/wsx/output/enhanced_checkpoints", dim_per_token=768,
                          )
        # self.train_set = DataSet("/media/zzf/ljn/wsx/output/weight_split_12/enhanced_checkpoints", dim_per_token=768,
        #                          )
        # self.train_set = DataSet("/media/zzf/ljn/wsx/PGFA/PGFA-main/PGFA-main/output/weight/enhanced_checkpoints", dim_per_token=768,
        #                          )
    ...
    def load_model(self, in_channels, hidden_channels, hidden_dim,
        ...
        # self.load_vae_weights(self.vae, "/media/zzf/ljn/wsx/output/VAE_model/vae/best_vae_0.16012847423553467.pt")
        # self.load_vae_weights(self.vae,'weight_log/best_vae.pt')
        ...
        # self.load_vae_weights(self.vae,
        #                       '/media/zzf/ljn/wsx/PGFA/PGFA-main/output/VAE_model/vae/best_vae_0.2218574434518814.pt')  # acc:85.28
        # self.load_vae_weights(self.vae,
        #                       '/media/zzf/ljn/wsx/PGFA/PGFA-main/output/learnable_vae/lr_vae/best_vae_0.2218574434518814.pt')
    ...
    def train_vae(self, epoch):
            ...
            if self.dim_loss < self.best_loss:
                ...
                self.best_loss = self.dim_loss
                self.save_vae_model('weight_log/55:5vae/best_vae_{}.pt'.format(self.best_loss))
                this_steps = 0
                train_loss = 0
            # if batch_idx >= 500:
            #     break
