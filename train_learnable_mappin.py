...
class Processor:
    ...
    def load_data(self, train_list, train_label, test_list, test_label, batch_size, language_path):
        ...
        # self.train_set = DataSet("/media/zzf/ljn/wsx/PGFA/PGFA-main/PGFA-main/output/weight/enhanced_checkpoints",
        #                          dim_per_token=768,
        #                          )
    ...
    def load_model(self, in_channels, hidden_channels, hidden_dim,
        ...
        # self.load_transfer_weight(self.mapper,"/media/zzf/ljn/wsx/PGFA/PGFA-main/output/mapper/mapper_best_loss.pt")
    ...
    def train_mappin(self, epoch):
        ...
        ske_mappin=self.mapper(text_diction['adapter.weight'].cuda(),text_diction['adapter.bias'].cuda())
        self.load_ske_weights_map(self.text_adapter,text_diction)
        self.load_ske_weights_map(self.ske_adapter,ske_mappin)
        self.test_epoch_prediction(epoch)
    ...
    def test_epoch_prediction(self,prediction, unseen_label, epoch, DA, support_factor):
        ...
        self.ske_bias=self.mapper(self.weight['adapter.weight'].cuda(),self.weight['adapter.bias'].cuda())
